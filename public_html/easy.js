...
aEat.src='music/pacman.mp3';
aDie.src='music/Pac death.mp3';
ibody.src='image/jake.jpg';
ifood.src='image/dev.jpg';
...
function snakeDraw() {
    for (var index = 0; index < snake.length; index++) {
        ...
        context.drawImage(ibody ,snake[index].x * snakeSize, snake[index].y * snakeSize, snakeSize, snakeSize);
/* --------------------------------------------------------------------------------------------
* Border
* --------------------------------------------------------------------------------------------
*/
